...
export default function PrincipalEventCalendar({ userRole, canEdit = true }) {
                ...
                <motion.div className="flex items-center justify-between" variants={itemVariants}>
                    <div>
                        <motion.h1
                            ...
                            className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent bg-[length:200%_100%] text-2xl font-bold"
                        >
                            Event Calendar
                        </motion.h1>
